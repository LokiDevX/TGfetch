<p align="center">
  <img src="./Gemini_Generated_Image_tkr23itkr23itkr2.png" alt="TGfetch Logo" width="420" />
</p>
...
Create a `.env` file in the project root (if it doesn't already exist) with your Telegram API credentials:
